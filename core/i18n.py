...
STR = {
    ...
    "res.exp": ("集めた光", "Light gathered"),
    "res.hero_up": ("加護 Lv UP!", "Blessing UP!"),
    "inn.train": ("加護を受ける (加護 Lv{0}{1})", "Receive blessing (Lv{0}{1})"),
    "train.title": ("大精霊の加護", "The Great Spirit's Blessing"),
    "train.points": ("加護の力", "Blessing points"),
    "train.next": ("次の加護まで", "Next blessing"),
    "train.stats": ("身体への加護", "Blessings of the body"),
    "train.skills": ("特別な加護", "Special blessings"),
    "train.done": ("授かった", "Granted"),
    "train.hint": ("A: 授かる  B: 戻る", "A: receive  B: back"),
