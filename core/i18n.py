...
STR = {
    ...
    "res.exp": ("熟練 EXP", "Mastery EXP"),
    "res.hero_up": ("熟練 Lv UP!", "Mastery UP!"),
    "inn.train": ("鍛錬する (熟練 Lv{0}{1})", "Train (Mastery Lv{0}{1})"),
    "train.title": ("鍛錬", "Training"),
    "train.points": ("ポイント", "Points"),
    "train.next": ("次の Lv まで", "Next Lv"),
    "train.stats": ("基礎能力", "Attributes"),
    "train.skills": ("スキル", "Skills"),
    "train.done": ("習得済み", "Learned"),
    "train.hint": ("A: 振る  B: 戻る", "A: spend  B: back"),
