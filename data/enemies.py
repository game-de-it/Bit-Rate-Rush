...
ENEMIES = {
    ...
    "coda":   dict(name=("光を喰う者", "The Devourer"), hp=3600, spd=0.45, dmg=32, xp=500, r=12, sprite=S.CODA, boss=True, final=True,
                   summon=["wisp", "skull", "archer"], summon_n=8, summon_cd=220,
                   shots=14, shoot_cd=140, shot_spd=1.5, aimed=True, spiral=True, dash=(140, 26, 3.5)),
