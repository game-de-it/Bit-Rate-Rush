...
ITEMS = {
    ...
    # ---- 後編 ----
    "smoke":  dict(chapter=8, price=350, col=13, name=("煙玉", "Smoke Bomb"), desc=("5 秒間 敵が足を止める", "Enemies freeze for 5 s")),
    "whetstone": dict(chapter=10, price=450, col=6, name=("砥石", "Whetstone"), desc=("30 秒間 攻撃力 +50%", "Damage +50% for 30 s")),
}
